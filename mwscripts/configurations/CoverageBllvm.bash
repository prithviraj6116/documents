...
runCoverage()
{
    ...
    if [[ $1 == "cn" ]]; then
        ...
        mw sbruntests -sbmcovsummary-args="-diff /mathworks/devel/sbs/50/Bllvm.$jobPrevious.sb" -runallunder $testDir -unbp g1951218 -unbp g1922971 
        sbmcovsetup -disable
        sleep 600
        ...
        echo "starting sbruntests"
        mw sbruntests -sbmcovsummary-args="-diff /mathworks/devel/sbs/50/Bsfml.$jobPrevious.sb" -runallunder $testDir -unbp g1951218 -unbp g1922971 
        sbmcovsetup -disable
        sleep 600
    else
...
mailToMe()
{
        ...
        Reproduction Commands:
                  ...
                  sbmcovsetup $sbmcovsetupargs
                  mw sbruntests -sbmcovsummary-args="-diff /mathworks/devel/sbs/50/Bllvm.$jobPrevious.sb" -runallunder $testDir;

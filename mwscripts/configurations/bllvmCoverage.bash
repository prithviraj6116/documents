...
USER1=ppatil
USER2=ppatil
FILELISTComplete=/mathworks/devel/sandbox/$USER1/misc/configurations/BsfmlSF4MLFilesForCodeCoverageCompleteSet.txt
FILELISTLimited=/mathworks/devel/sandbox/$USER1/misc/configurations/BsfmlSF4MLFilesForCodeCoverageLimitedSet.txt
sbsNameCN=null
...
runCoverage()
{
    ...
    mw sbruntests -sbmcovsummary-args="-diff /mathworks/devel/sbs/50/Bsfml.$jobPrevious.sb -dirview" -runallunder $testDir -unbp g1922971
    sbmcovsetup -disable
    sleep 600
}
...
mailToMe()
{
        ...
        Reproduction Commands:
                  ...
                  sbmcovsetup $sbmcovsetupargs
                  mw sbruntests -sbmcovsummary-args="-diff /mathworks/devel/sbs/50/Bsfml.$jobPrevious.sb -dirview" -runallunder $testDir -unbp g1951218 -unbp g1922971;
